  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          '0%, 100%': { textShadow: '0 0 20px hsl(var(--primary) / 0.5)' },
          '50%': {
            textShadow:
              '0 0 30px hsl(var(--primary) / 0.8), 0 0 40px hsl(var(--primary) / 0.5)',
          },
        },
        shimmer: {
